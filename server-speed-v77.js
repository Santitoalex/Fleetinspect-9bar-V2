...
if (!adminHtml.includes('href="/admin-v100.css')) {
  adminHtml = adminHtml.replace(
    "\n </head>",
    '  <link rel="stylesheet" href="/admin-v100.css?v=108" />\n\n </head>'
  );
}
...
adminHtml = adminHtml
  .replaceAll("/admin.js?v=100", "/admin.js?v=108")
  .replaceAll("/admin-v100.css?v=103", "/admin-v100.css?v=108")
  .replaceAll("/admin-v100.js?v=103", "/admin-v100.js?v=108");

if (!adminHtml.includes('src="/admin-v100.js')) {
  adminHtml = adminHtml.replace(
    "\n </body>",
    '  <script src="/admin-v100.js?v=108"></script>\n </body>'
  );
}
...
serviceWorker = serviceWorker
  ...
  .replace('"/admin.html",', '"/admin.html",\n  "/admin-v92.css?v=108",\n  "/admin-v100.css?v=108",\n  "/admin-v100.js?v=108",');
serviceWorker = serviceWorker
  .replaceAll("fleetinspect-driver-v103", "fleetinspect-driver-v108")
  .replaceAll("?v=103", "?v=108")
  .replaceAll("/admin.js?v=100", "/admin.js?v=108");
