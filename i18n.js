window.FI18N = (() => {
  const translations = {
    en: {
      ...
      ,userManagementSubtitle: "Owner control for dispatcher access and roles"
      ...
      ,roleOwnerHelp: "Full control and user roles."
      ,roleSupervisorHelp: "Can operate the dashboard."
      ,roleDispatcherHelp: "Can review daily operations."
      ,roleReadonlyHelp: "Can view reports only."
      ,configuredAccount: "Configured in Render"
      ,editableAccount: "Editable account"
      ,roleCouldNotUpdate: "The role could not be updated."
      ...
      ,routePlanCouldNotLoad: "The route plan could not be loaded."
      ,routePlanCouldNotSave: "The route plan could not be saved."
      ,routePlanCouldNotClear: "The route plan could not be cleared."
      ,routePlanSaving: "Saving planned routes..."
      ,routePlanSaved: "{count} planned route(s) saved."
      ,routePlanSavedLocal: "Saved only on this device. Server sync failed: {error}"
      ,routePlanCleared: "Route plan cleared."
      ,serverReturnedInvalidResponse: "The server returned an invalid response. Render may still be running an old version."
    ...
    es: {
      ...
      ,userManagementSubtitle: "Control del propietario para accesos y roles"
      ,refreshUsers: "Actualizar usuarios"
      ,loadingUsers: "Cargando usuarios..."
      ,usersCouldNotLoad: "No se pudieron cargar los usuarios."
      ...
      ,roleOwnerHelp: "Control total y roles de usuarios."
      ,roleSupervisorHelp: "Puede operar el dashboard."
      ,roleDispatcherHelp: "Puede revisar operaciones diarias."
      ,roleReadonlyHelp: "Solo puede ver reportes."
      ,configuredAccount: "Configurado en Render"
      ,editableAccount: "Cuenta editable"
      ,roleCouldNotUpdate: "No se pudo actualizar el rol."
      ,readonlyMode: "Esta cuenta es de solo lectura."
      ...
      ,routePlanCouldNotLoad: "No se pudo cargar el plan de rutas."
      ,routePlanCouldNotSave: "No se pudo guardar el plan de rutas."
      ,routePlanCouldNotClear: "No se pudo borrar el plan de rutas."
      ,routePlanSaving: "Guardando rutas planificadas..."
      ,routePlanSaved: "{count} ruta(s) planificadas guardadas."
      ,routePlanSavedLocal: "Guardado solo en este dispositivo. Falló la sincronización con el servidor: {error}"
      ,routePlanCleared: "Plan de rutas borrado."
      ,serverReturnedInvalidResponse: "El servidor devolvió una respuesta no válida. Render puede seguir usando una versión antigua."
    ...
    de: {
      ...
      ,userManagementSubtitle: "Owner-Kontrolle für Zugriff und Rollen"
      ,refreshUsers: "Benutzer aktualisieren"
      ,loadingUsers: "Benutzer werden geladen..."
      ,usersCouldNotLoad: "Benutzer konnten nicht geladen werden."
      ...
      ,roleOwnerHelp: "Volle Kontrolle und Benutzerrollen."
      ,roleSupervisorHelp: "Kann das Dashboard bedienen."
      ,roleDispatcherHelp: "Kann Tagesbetrieb prüfen."
      ,roleReadonlyHelp: "Kann Berichte nur ansehen."
      ,configuredAccount: "In Render konfiguriert"
      ,editableAccount: "Bearbeitbares Konto"
      ,roleCouldNotUpdate: "Die Rolle konnte nicht aktualisiert werden."
      ,readonlyMode: "Dieses Konto ist nur lesend."
      ...
      ,routePlanCouldNotLoad: "Der Routenplan konnte nicht geladen werden."
      ,routePlanCouldNotSave: "Der Routenplan konnte nicht gespeichert werden."
      ,routePlanCouldNotClear: "Der Routenplan konnte nicht gelöscht werden."
      ,routePlanSaving: "Geplante Routen werden gespeichert..."
      ,routePlanSaved: "{count} geplante Route(n) gespeichert."
      ,routePlanSavedLocal: "Nur auf diesem Gerät gespeichert. Serversynchronisierung fehlgeschlagen: {error}"
      ,routePlanCleared: "Routenplan gelöscht."
      ,serverReturnedInvalidResponse: "Der Server hat eine ungültige Antwort zurückgegeben. Render verwendet möglicherweise noch eine alte Version."
    ...
    ro: {
      ...
      ,userManagementSubtitle: "Control owner pentru acces și roluri"
      ,refreshUsers: "Actualizează utilizatori"
      ,loadingUsers: "Se încarcă utilizatorii..."
      ,usersCouldNotLoad: "Utilizatorii nu au putut fi încărcați."
      ,noUsersYet: "Nu există utilizatori încă."
      ,role: "Rol"
      ,roleOwner: "Owner"
      ,roleSupervisor: "Supervisor"
      ,roleDispatcher: "Dispatcher"
      ,roleReadonly: "Doar citire"
      ,roleOwnerHelp: "Control complet și roluri utilizatori."
      ,roleSupervisorHelp: "Poate opera dashboard-ul."
      ,roleDispatcherHelp: "Poate verifica operațiunile zilnice."
      ,roleReadonlyHelp: "Poate vedea doar rapoarte."
      ,configuredAccount: "Configurat în Render"
      ,editableAccount: "Cont editabil"
      ,roleCouldNotUpdate: "Rolul nu a putut fi actualizat."
      ,readonlyMode: "Acest cont este doar pentru citire."
      ...
      ,routePlanCouldNotLoad: "Planul de rute nu a putut fi încărcat."
      ,routePlanCouldNotSave: "Planul de rute nu a putut fi salvat."
      ,routePlanCouldNotClear: "Planul de rute nu a putut fi șters."
      ,routePlanSaving: "Se salvează rutele planificate..."
      ,routePlanSaved: "{count} rută/rute planificate salvate."
      ,routePlanSavedLocal: "Salvat doar pe acest dispozitiv. Sincronizarea cu serverul a eșuat: {error}"
      ,routePlanCleared: "Planul de rute a fost șters."
      ,serverReturnedInvalidResponse: "Serverul a returnat un răspuns invalid. Render poate rula încă o versiune veche."
