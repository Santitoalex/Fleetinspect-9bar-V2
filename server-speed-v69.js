...
const runnerPath = path.join(process.cwd(), ".runtime", "server-speed-v69.runner.mjs");
...
runner = runner
  .replaceAll("server-speed-v63", "server-speed-v69")
  .replaceAll("admin-natural-v63", "admin-natural-v69")
  .replaceAll('"63"', '"69"');
