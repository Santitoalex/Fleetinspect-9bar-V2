...
const runnerPath = path.join(process.cwd(), ".runtime", "server-speed-v72.runner.mjs");
...
runner = runner
  .replaceAll("server-speed-v63", "server-speed-v72")
  .replaceAll("admin-natural-v63", "admin-natural-v72")
  .replaceAll('"63"', '"72"');
