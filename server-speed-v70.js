...
const runnerPath = path.join(process.cwd(), ".runtime", "server-speed-v70.runner.mjs");
...
runner = runner
  .replaceAll("server-speed-v63", "server-speed-v70")
  .replaceAll("admin-natural-v63", "admin-natural-v70")
  .replaceAll('"63"', '"70"');
