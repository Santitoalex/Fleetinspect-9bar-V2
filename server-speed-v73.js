...
const runnerPath = path.join(process.cwd(), ".runtime", "server-speed-v73.runner.mjs");
...
runner = runner
  .replaceAll("server-speed-v63", "server-speed-v73")
  .replaceAll("admin-natural-v63", "admin-natural-v73")
  .replaceAll('"63"', '"73"');
