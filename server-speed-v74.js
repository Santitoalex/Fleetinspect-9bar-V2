...
const runnerPath = path.join(process.cwd(), ".runtime", "server-speed-v74.runner.mjs");
...
runner = runner
  .replaceAll("server-speed-v63", "server-speed-v74")
  .replaceAll("admin-natural-v63", "admin-natural-v74")
  .replaceAll('"63"', '"74"');
